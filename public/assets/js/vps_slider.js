...
$(document).ready(function () {
  $("#slider").slider({
    ...
    change: function (event, ui) {
      ...
      $(".vps_slider_box #bandwidth_val span.value").html(
        bandwidth_arr[ui.value - 1]
      );
      $(".vps_slider_box #price").html(price_arr[ui.value - 1]);
      $(".vps_slider_box a.ordernow_btn").attr(
