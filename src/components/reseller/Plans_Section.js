          ...
          <div className="row">
            <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <div className="plans_content">
                <h2>
                  Cheap Reseller Hosting in Pakistan - High-Value Low Price
                </h2>
                <p>
                  No One can offer Discounts and Services like Zthosting,Cheap
                  Reseller Hosting in Pakistan with 100% Uptime, Weekly
                  Incremental Backups on the remote location, Whitelabel DNS,
                  Discounted Billing System (WHMCS), Multi-Location Datacenter,
                  Unlimited Storage and Bandwidth with Overselling feature.
                </p>
              </div>
            </div>
          </div>
