          ...
          <div className="row">
            <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <div className="plans_content">
                <h2>
                  cPanel Shared Web Hosting in Pakistan - cPanel Best Web
                  hosting
                </h2>
                <p>
                  We are the best web hosting for small businesses in Pakistan.
                  We have designed our cPanel Shared Web Hosting package at a
                  meager price, but it does not lack quality. The Shared Hosting
                  package comes with a 30-day money-back guarantee. Buy your
                  desired Web hosting packages here, or go for a business
                  hosting package.
                </p>
              </div>
            </div>
